...
var r = (function () {
  function t() {
    ...
    // 🔴 GIU "go88", KHONG doi thanh "roy88". Day KHONG phai nhan hieu hien ra man hinh, no la
    //    co RE NHANH GIAO DIEN: HeaderUi.js:261 lam `enviromentName.includes("go88")` de quyet
    //    dinh bat/tat nodeDomain. Doi chuoi nay = giao dien lech Go88, pham muc tieu "sinh doi".
    //    No con lam co bat log go roi: GameController.js:282/1059/1149 chi gui log khi ten co
    //    chua "pre" — de "go88" thi khong bao gio gui, dung y ta muon (khong ban gi sang Go88).
    this.enviromentName = "go88";
