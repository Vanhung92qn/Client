...
(function () {
    cc.DragonTigerMoveChip = cc.Class({
        ...
        createChip: function (value) {
            let chip = null;
            // Fallback: nếu chip value vượt range client (vd 5M/10M), dùng chip cao nhất
            if (this.listMap[value] === undefined || !this.listPools[value]) {
                let keys = Object.keys(this.listMap).map(Number).sort(function (a, b) { return a - b; });
