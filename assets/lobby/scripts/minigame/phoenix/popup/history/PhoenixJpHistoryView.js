...
cc.PhoenixJpHistoryView = cc.Class({
    ...
    getTopSessionWinners: function () {
        var aviatorGetHistoryJackpotCommand = new cc.PhoenixGetHistoryJackpotCommand;
    ...
    closeClicked: function () {
        ...
        cc.director.getScheduler().schedule(function () {
            self.animation.stop();
            cc.PhoenixPopupController.getInstance().destroyJpHistoryView();
        }, this, 1, 0, delay, false);
    },
    ...
    updatePage: function () {
        ...
        for (var i = 0; i < this.listItems.children.length; i++) {
            ...
            if (itemData) {
                node.active = true;
                var a = node.getComponent(cc.PhoenixJpHistoryItem);
