...
var a = t("./GameController"),
  s = t("./MessageCardGameHandler"),
  r = t("./GamePlayManager"),
  c = t("./BaCayMessage"),
  l = t("./BaCayScoreUI"),
  h = t("./MusicPlayer"),
  u = t("./GameCardSprite"),
  d = t("./GameCardSpriteType"),
  p = t("./GameZOrder"),
  f = t("./BaCayRequest"),
  g = t("./CommonPrefabsManager"),
  m = t("./GameConfigManager"),
  y = t("./PoolManager"),
  S = t("./ChipCaoRuaController"),
  _ = t("./StringUtil"),
  v = t("./ParticleCaoRua"),
  b = t("./ProcessCountdown"),
  C = t("./BaCayAnimExtratime"),
  T = t("./CardGameCommonRequest"),
  E = t("./AnalyticsManager"),
  I = cc._decorator,
  A = I.ccclass,
  P = I.property,
  M = function(t) {
